...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"XIP4":[function(require,module,exports) {
"use strict";
...
},{}],"bv5m":[function(require,module,exports) {
...
},{"@lezer/common":"XIP4","process":"pBGv"}],"cCFh":[function(require,module,exports) {
"use strict";
...
const parser = _lr.LRParser.deserialize({
  ...
  maxTerm: 25,
  nodeProps: [[_common.NodeProp.openedBy, 7, "{", 12, "["], [_common.NodeProp.closedBy, 8, "}", 13, "]"]],
  skippedNodes: [0],
  repeatNodeCount: 2,
...
exports.parser = parser;
},{"@lezer/lr":"bv5m","@lezer/common":"XIP4"}],"UnYr":[function(require,module,exports) {
"use strict";
...
exports.Line = Line;
},{}],"XrxK":[function(require,module,exports) {
var process = require("process");
"use strict";
...
exports.StateField = exports.StateEffectType = exports.StateEffect = exports.SelectionRange = exports.Prec = exports.MapMode = exports.Facet = exports.EditorState = exports.EditorSelection = exports.Compartment = exports.CharCategory = exports.ChangeSet = exports.ChangeDesc = exports.AnnotationType = exports.Annotation = void 0;
  ...
  static resolve(base, compartments, oldState) {
    ...
    for (let id in facets) {
      ...
      /* Static */
        ...
        dynamicDeps.push(providers.filter(p => p.type != 0
        /* Static */
        ).map(d => d.id));
      }
    }
    ...
    if (oldState) {
      ...
      for (let id in address) {
        let cur = address[id],
            prev = oldState.config.address[id];
...
},{"@codemirror/text":"UnYr","process":"pBGv"}],"fdX2":[function(require,module,exports) {
"use strict";
...
// (min-width: 400px)": {...}}`.
},{}],"UHU4":[function(require,module,exports) {
"use strict";
...
},{"@codemirror/state":"XrxK"}],"TYP6":[function(require,module,exports) {
"use strict";
...
},{}],"rpuU":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.PluginFieldProvider = exports.PluginField = exports.MatchDecorator = exports.EditorView = exports.Direction = exports.Decoration = exports.BlockType = exports.BlockInfo = exports.BidiSpan = void 0;
...
exports.__test = exports.WidgetType = exports.ViewUpdate = exports.ViewPlugin = void 0;
...
class WidgetBufferView extends ContentView {
  ...
  get overrideDOMText() {
    return _text.Text.of([this.dom.nodeValue.replace(/\u200b/g, "")]);
  }
...
const inputHandler = /*@__PURE__*/_state.Facet.define(); // FIXME remove
...
},{"@codemirror/state":"XrxK","style-mod":"fdX2","@codemirror/rangeset":"UHU4","@codemirror/text":"UnYr","w3c-keyname":"TYP6"}],"Vyo7":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.TreeIndentContext = exports.ParseContext = exports.LanguageSupport = exports.LanguageDescription = exports.Language = exports.LRLanguage = exports.IndentContext = void 0;
...
exports.flatIndent = void 0;
exports.foldInside = foldInside;
exports.foldService = exports.foldNodeProp = void 0;
...
const parseWorker = /*@__PURE__*/_view.ViewPlugin.fromClass(class ParseWorker {
  ...
  work(deadline) {
    ...
    let time = Math.min(this.chunkBudget, 100
    /* Slice */
    , deadline ? Math.max(25
    /* MinSlice */
...
},{"@lezer/common":"XIP4","@codemirror/state":"XrxK","@codemirror/view":"rpuU","@codemirror/text":"UnYr"}],"FAni":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.defaultHighlightStyle = exports.classHighlightStyle = exports.Tag = exports.HighlightStyle = void 0;
...
},{"@lezer/common":"XIP4","style-mod":"fdX2","@codemirror/view":"rpuU","@codemirror/state":"XrxK","@codemirror/language":"Vyo7","@codemirror/rangeset":"UHU4"}],"oLSN":[function(require,module,exports) {
"use strict";
...
exports.json = json;
exports.jsonParseLinter = exports.jsonLanguage = void 0;

var _json = require("@lezer/json");
...
const jsonLanguage = /*@__PURE__*/_language.LRLanguage.define({
  parser: /*@__PURE__*/_json.parser.configure({
    props: [/*@__PURE__*/_language.indentNodeProp.add({
      Object: /*@__PURE__*/(0, _language.continuedIndent)({
        except: /^\s*\}/
      }),
      Array: /*@__PURE__*/(0, _language.continuedIndent)({
        except: /^\s*\]/
      })
    }), /*@__PURE__*/_language.foldNodeProp.add({
      "Object Array": _language.foldInside
    }), /*@__PURE__*/(0, _highlight.styleTags)({
      String: _highlight.tags.string,
      Number: _highlight.tags.number,
      "True False": _highlight.tags.bool,
...
function json() {
  return new _language.LanguageSupport(jsonLanguage);
}
},{"@lezer/json":"cCFh","@codemirror/language":"Vyo7","@codemirror/highlight":"FAni"}],"nL7O":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.GutterMarker = void 0;
  ...
  syncGutters(detach) {
    ...
    for (let line of this.view.viewportLineBlocks) {
      ...
      if (Array.isArray(line.type)) {
        ...
        text = line.type == _view.BlockType.Text ? line : undefined;
      }
...
},{"@codemirror/view":"rpuU","@codemirror/rangeset":"UHU4","@codemirror/state":"XrxK"}],"skrK":[function(require,module,exports) {
"use strict";
...
},{"@codemirror/state":"XrxK","@codemirror/view":"rpuU"}],"NFdU":[function(require,module,exports) {
"use strict";
...
exports.foldEffect = exports.foldCode = exports.foldAll = void 0;
exports.foldGutter = foldGutter;
exports.foldKeymap = void 0;
...
},{"@codemirror/state":"XrxK","@codemirror/view":"rpuU","@codemirror/language":"Vyo7","@codemirror/gutter":"nL7O","@codemirror/rangeset":"UHU4"}],"zHUi":[function(require,module,exports) {
"use strict";
...
},{"@codemirror/state":"XrxK","@codemirror/language":"Vyo7","@codemirror/view":"rpuU","@lezer/common":"XIP4"}],"Bnjc":[function(require,module,exports) {
"use strict";
...
},{"@codemirror/state":"XrxK","@codemirror/text":"UnYr","@codemirror/view":"rpuU","@codemirror/matchbrackets":"zHUi","@codemirror/language":"Vyo7","@lezer/common":"XIP4"}],"drYF":[function(require,module,exports) {
"use strict";
...
},{"@codemirror/view":"rpuU","@codemirror/state":"XrxK","@codemirror/rangeset":"UHU4","@codemirror/text":"UnYr","@codemirror/language":"Vyo7"}],"VnFr":[function(require,module,exports) {
"use strict";
...
},{"@codemirror/view":"rpuU","@codemirror/state":"XrxK"}],"VAXB":[function(require,module,exports) {
"use strict";
...
},{}],"QLgH":[function(require,module,exports) {
"use strict";
...
exports.setSearchQuery = exports.selectSelectionMatches = exports.selectNextOccurrence = exports.selectMatches = exports.searchKeymap = void 0;
...
},{"@codemirror/view":"rpuU","@codemirror/state":"XrxK","@codemirror/panel":"VnFr","@codemirror/rangeset":"UHU4","crelt":"VAXB","@codemirror/text":"UnYr"}],"IVG4":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.closeHoverTooltips = void 0;
...
const tooltipPlugin = /*@__PURE__*/_view.ViewPlugin.fromClass(class {
  constructor(view) {
    ...
    this.intersectionObserver = typeof IntersectionObserver == "function" ? new IntersectionObserver(entries => {
      if (this.intersectionTimeout < 0 && Date.now() > this.lastTransaction - 50 && entries.length > 0 && entries[entries.length - 1].intersectionRatio < 1) this.intersectionTimeout = setTimeout(() => {
        this.intersectionTimeout = -1;
        this.maybeMeasure();
      }, 50);
    }, {
  ...
  writeMeasure(measured) {
    ...
    for (let i = 0; i < this.manager.tooltips.length; i++) {
      ...
      let offset = tView.offset || noOffset,
          ltr = this.view.textDirection == _view.Direction.LTR;
...
},{"@codemirror/view":"rpuU","@codemirror/state":"XrxK"}],"z7E4":[function(require,module,exports) {
"use strict";
...
exports.completeAnyWord = exports.closeCompletion = exports.clearSnippet = void 0;
...
},{"@codemirror/state":"XrxK","@codemirror/view":"rpuU","@codemirror/tooltip":"IVG4","@codemirror/language":"Vyo7","@codemirror/text":"UnYr"}],"IJIq":[function(require,module,exports) {
"use strict";
...
},{"@codemirror/state":"XrxK"}],"FCWU":[function(require,module,exports) {
"use strict";
...
function rectangleFor(state, a, b) {
  ...
  if (a.off > MaxOff || b.off > MaxOff || a.col < 0 || b.col < 0) {
    ...
    for (let i = startLine; i <= endLine; i++) {
      let line = state.doc.line(i);
      let start = (0, _text.findColumn)(line.text, startCol, state.tabSize, true);

      if (start > -1) {
        let end = (0, _text.findColumn)(line.text, endCol, state.tabSize);
...
},{"@codemirror/state":"XrxK","@codemirror/view":"rpuU","@codemirror/text":"UnYr"}],"NdmB":[function(require,module,exports) {
"use strict";
...
const lintGutterExtension = /*@__PURE__*/(0, _gutter.gutter)({
...
},{"@codemirror/view":"rpuU","@codemirror/state":"XrxK","@codemirror/tooltip":"IVG4","@codemirror/panel":"VnFr","@codemirror/gutter":"nL7O","@codemirror/rangeset":"UHU4","crelt":"VAXB"}],"epd5":[function(require,module,exports) {
"use strict";
...
desired.
*/
const basicSetup = [/*@__PURE__*/(0, _gutter.lineNumbers)(), /*@__PURE__*/(0, _gutter.highlightActiveLineGutter)(), /*@__PURE__*/(0, _view.highlightSpecialChars)(), /*@__PURE__*/(0, _history.history)(), /*@__PURE__*/(0, _fold.foldGutter)(), /*@__PURE__*/(0, _view.drawSelection)(), /*@__PURE__*/(0, _view.dropCursor)(), /*@__PURE__*/_state.EditorState.allowMultipleSelections.of(true), /*@__PURE__*/(0, _language.indentOnInput)(), _highlight.defaultHighlightStyle.fallback, /*@__PURE__*/(0, _matchbrackets.bracketMatching)(), /*@__PURE__*/(0, _closebrackets.closeBrackets)(), /*@__PURE__*/(0, _autocomplete.autocompletion)(), /*@__PURE__*/(0, _rectangularSelection.rectangularSelection)(), /*@__PURE__*/(0, _view.highlightActiveLine)(), /*@__PURE__*/(0, _search.highlightSelectionMatches)(), /*@__PURE__*/_view.keymap.of([..._closebrackets.closeBracketsKeymap, ..._commands.defaultKeymap, ..._search.searchKeymap, ..._history.historyKeymap, ..._fold.foldKeymap, ..._comment.commentKeymap, ..._autocomplete.completionKeymap, ..._lint.lintKeymap])];
exports.basicSetup = basicSetup;
},{"@codemirror/view":"rpuU","@codemirror/state":"XrxK","@codemirror/history":"skrK","@codemirror/fold":"NFdU","@codemirror/language":"Vyo7","@codemirror/gutter":"nL7O","@codemirror/commands":"Bnjc","@codemirror/matchbrackets":"zHUi","@codemirror/closebrackets":"drYF","@codemirror/search":"QLgH","@codemirror/autocomplete":"z7E4","@codemirror/comment":"IJIq","@codemirror/rectangular-selection":"FCWU","@codemirror/highlight":"FAni","@codemirror/lint":"NdmB"}],"m3VC":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.lightThemeExtensions = exports.lightTheme = exports.lightHighlighting = exports.darkThemeExtensions = exports.darkTheme = exports.darkHighlighting = void 0;
...
var lightTheme = _basicSetup.EditorView.theme({
  "&": {
    fontSize: "12pt"
  },
  ".cm-content": {
...
var darkColors = {
  ...
  oneDark: {
    highlightBackground: "#202530",
    // dark.codeBackground
    selection: "#547370",
    // "#3E4451" combined with the accent color #95FFCD twice
...
var darkTheme = _basicSetup.EditorView.theme(_defineProperty({
  "&": {
  ...
  "&.cm-focused .cm-cursor": {
    borderLeftColor: darkColors.enki.primary
  },
  ...
  "&.cm-focused .cm-matchingBracket, &.cm-focused .cm-nonmatchingBracket": {
    backgroundColor: darkColors.oneDark.selectionMatch,
    outline: "1px solid ".concat(darkColors.enki.primary)
  },
  ".cm-gutters": {
    backgroundColor: darkColors.enki.background,
...
var darkHighlighting = _highlight.HighlightStyle.define([{
  tag: _highlight.tags.keyword,
  color: darkColors.oneDark.violet
}, {
...
}, // updated
{
  ...
  color: darkColors.oneDark.chalky
}, {
  ...
  color: darkColors.oneDark.invalid
}, {
  tag: [_highlight.tags.function(_highlight.tags.variableName), _highlight.tags.labelName, _highlight.tags.propertyName],
...
exports.darkHighlighting = darkHighlighting;

var lightHighlighting = _highlight.HighlightStyle.define([{
  tag: _highlight.tags.link,
  textDecoration: "underline"
}, {
  tag: _highlight.tags.heading,
...
exports.lightHighlighting = lightHighlighting;
var darkThemeExtensions = [darkTheme, darkHighlighting];
exports.darkThemeExtensions = darkThemeExtensions;
var lightThemeExtensions = [lightTheme, lightHighlighting];
exports.lightThemeExtensions = lightThemeExtensions;
},{"@codemirror/basic-setup":"epd5","@codemirror/highlight":"FAni"}],"fqJo":[function(require,module,exports) {
"use strict";
...
var consoleLog = function consoleLog(type, log) {
...
console = {
  log: function log(_log) {
    return consoleLog("log", _log);
  },
  debug: function debug(log) {
    return consoleLog("debug", log);
  },
  info: function info(log) {
    return consoleLog("info", log);
  },
  warn: function warn(log) {
    return consoleLog("warn", log);
  },
  error: function error(log) {
    return consoleLog("error", log);
  }
}; // TODOS:
// - extracting theme
...
var languages = new _state.Compartment();
var themes = new _state.Compartment();

var mapKeywordString = function mapKeywordString(kString) {
  return kString.split(" ").map(function (kw) {
    return {
      label: kw,
      type: "keyword"
    };
...
var initialState = _state.EditorState.create({
  ...
  extensions: [_basicSetup.basicSetup, _view.EditorView.updateListener.of(function (v) {
    var doc = v.state.doc;
  ...
  }), (0, _gutter.lineNumbers)(), (0, _gutter.highlightActiveLineGutter)(), (0, _view.highlightSpecialChars)(), (0, _view.drawSelection)(), _state.EditorState.allowMultipleSelections.of(true), (0, _language.indentOnInput)(), _highlight.defaultHighlightStyle.fallback, themes.of(_theme.darkThemeExtensions), (0, _matchbrackets.bracketMatching)(), (0, _closebrackets.closeBrackets)(), (0, _autocomplete.autocompletion)(), (0, _view.highlightActiveLine)(), (0, _search.highlightSelectionMatches)(), _view.keymap.of([_commands.indentWithTab].concat(_toConsumableArray(_closebrackets.closeBracketsKeymap), _toConsumableArray(_commands.defaultKeymap), _toConsumableArray(_autocomplete.completionKeymap))), languages.of((0, _langJson.json)()), _view.EditorView.lineWrapping, _state.EditorState.languageData.of(function () {
    return [{
      autocomplete: _autocomplete.completeAnyWord
    }];
  }) // adds words from the editor as completions
  ]
});
...
var languageExtensionsMap = {
  json: _langJson.json
};

window.replaceLanguage = function (language) {
  var languageExtension = languageExtensionsMap[language];
...
window.replaceTheme = function (theme) {
  if (theme === "light") {
    view.dispatch({
      effects: themes.reconfigure(_theme.lightThemeExtensions)
    });
  } else if (theme === "dark") {
    view.dispatch({
      effects: themes.reconfigure(_theme.darkThemeExtensions)
    });
  } else {
    var _window;

    (_window = window) === null || _window === void 0 ? void 0 : _window.ReactNativeWebView.postMessage(JSON.stringify({
      event: "invalid-language",
      data: language
    }));
  }
...
window.simulateKeyPress = function () {
  var key = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "Enter";
  var element = document.querySelector(".cm-content");
...
window.onresize = function (x) {
  var element = document.querySelector(".cm-activeLine");
...
},{"@codemirror/lang-json":"oLSN","@codemirror/gutter":"nL7O","./theme":"m3VC","@codemirror/autocomplete":"z7E4","@codemirror/closebrackets":"drYF","@codemirror/matchbrackets":"zHUi","@codemirror/commands":"Bnjc","@codemirror/view":"rpuU","@codemirror/state":"XrxK","@codemirror/search":"QLgH","@codemirror/language":"Vyo7","@codemirror/highlight":"FAni","@codemirror/basic-setup":"epd5"}]},{},["fqJo"], null)
//# sourceMappingURL=editor.5b953833.js.map