...
import {
  View, StyleSheet, ViewProps, ScrollView, NativeModules,
} from 'react-native';
import {
  Paragraph,
  List,
    ...
    <>
      ...
      <ScrollView contentContainerStyle={{ paddingBottom: 60 }}>
        <Card style={[styles.card, { marginTop: 0 }]}>
          ...
          <Card.Content>
            <View>
              ...
              />
              <Caption>
                You can choose between original XMRig and MoneroOcean's fork
                that supports algo switching.
              </Caption>
        ...
        <Card style={[styles.card, { marginTop: 0 }]}>
          ...
          <Card.Content>
            ...
            <TextInput
              ...
              error={hostnameValidator.validate(
                localState.properties?.pool?.hostname,
              ).error != null}
            />
            <TextInput
              style={styles.input}
            ...
            <TextInput
              ...
              autoComplete={undefined}
              error={usernameValidator.validate(
                localState.properties?.pool?.username,
              ).error != null}
            />
            ...
            <TextInput
              ...
              error={passwordValidator.validate(
                localState.properties?.pool?.password,
              ).error != null}
              autoComplete={undefined}
            />
            <HelperText type="info" style={{ marginBottom: 2 }}>
        ...
        <Card style={styles.card}>
          ...
          <Card.Content>
            ...
            <View style={styles.input}>
              ...
              {localState.properties?.cpu?.random_x_mode === RandomXMode.FAST && (
              <HelperText type="error" visible={localState.properties?.cpu?.random_x_mode === RandomXMode.FAST}>
            ...
            <View style={styles.input}>
              <TextInput
                ...
                autoComplete={undefined}
                error={priorityValidator.validate(
                  localState.properties?.cpu?.priority,
                ).error != null}
                keyboardType="numeric"
              />
              <Caption>
            ...
            <View>
              <TextInput
                ...
                error={maxThreadsHintValidator.validate(
                  localState.properties?.cpu?.max_threads_hint,
                ).error != null}
                autoComplete={undefined}
                keyboardType="numeric"
              />
        ...
        <Card style={styles.card}>
          ...
          <Card.Content>
            <Caption>
              Enable/Disable miner supported algorithems,
              some of the algorithems can casue problems on some devices.
              If the miner is stuck/crash on some algorithem you can disable these algorithem.
            </Caption>
